...
#gold 조정해야함
shopping_list = {
    1: Inventory(name='hp potion', hp=10, gold=100),
    2: Inventory(name='mp potion', mp=5, gold=100),
    3: Inventory(name='용의 비늘(power +5)', power=10, gold=100),
    4: Inventory(name='magic_power up', magic_power=10, gold=100),
}
